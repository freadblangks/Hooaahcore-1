...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='Account System';
...
CREATE TABLE `realmlist` (
  ...
  `gamebuild` int unsigned NOT NULL DEFAULT '37474',
...
(1,'Hooaahcore','127.0.0.1','127.0.0.1','255.255.255.0',8085,0,0,1,0,0,37474,1,1);
...
CREATE TABLE `transfer_requests` (
  ...
  `type` enum('fee','free') NOT NULL DEFAULT 'fee',
...
CREATE TABLE `uptime` (
  ...
  `revision` varchar(255) NOT NULL DEFAULT 'Hooaahcore',
