...
char serviceLongName[] = "Hooaahcore world service";
char serviceDescription[] = "Hooaahcore World of Warcraft emulator world service";
/*
...
extern int main(int argc, char** argv)
{
    ...
    TC_LOG_INFO("server.worldserver", "HooaahCore official build");
