...
#define DEFINE_HANDLER(opcode, status, processing, handler) \
    ...
    DEFINE_HANDLER(CMSG_BATTLE_PAY_REQUEST_PRICE_INFO,                      STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL); // TODO: find this packet, needed on bpay. - Hooaah
...
#define DEFINE_SERVER_OPCODE_HANDLER(opcode, status, con) \
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CHARACTER_UPGRADE_COMPLETE,              STATUS_NEVER,        CONNECTION_TYPE_REALM); // is this really bpay??? -Hooaah
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CHARACTER_UPGRADE_MANUAL_UNREVOKE_RESULT,STATUS_UNHANDLED,    CONNECTION_TYPE_REALM);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CHARACTER_UPGRADE_STARTED,               STATUS_NEVER,        CONNECTION_TYPE_REALM); // is this really bpay?? -Hooaah
