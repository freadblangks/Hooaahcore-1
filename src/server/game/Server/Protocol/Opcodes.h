...
enum OpcodeClient : uint16
{
    ...
    // TODO: Find new opcode names, and opcodes. - Hooaah
    CMSG_GUILD_BANK_MOVE_ITEMS_PLAYER_BANK            = 0xBADD,
    CMSG_GUILD_BANK_MOVE_ITEMS_BANK_PLAYER            = 0xBADD,
    CMSG_GUILD_BANK_MOVE_ITEMS_BANK_BANK              = 0xBADD,
    CMSG_GUILD_BANK_MOVE_ITEMS_PLAYER_BANK_COUNT      = 0xBADD,
    CMSG_GUILD_BANK_MOVE_ITEMS_BANK_PLAYER_COUNT      = 0xBADD,
    CMSG_GUILD_BANK_MOVE_ITEMS_BANK_PLAYER_AUTO       = 0xBADD,
    CMSG_GUILD_BANK_MOVE_ITEMS_BANK_BANK_COUNT        = 0xBADD,
    CMSG_GUILD_BANK_MERGE_ITEMS_PLAYER_BANK           = 0xBADD,
    CMSG_GUILD_BANK_MERGE_ITEMS_BANK_PLAYER           = 0xBADD,
