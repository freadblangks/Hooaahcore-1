...
#undef LOAD_DB2
    ...
    for (TalentEntry const* talentInfo : sTalentStore)
    {
        ...
        ASSERT(talentInfo->TierID < MAX_TALENT_TIERS, "MAX_UI_MAP_SYSTEM must be at least %u", talentInfo->TierID + 1);
    ...
    if (!sAreaTableStore.LookupEntry(13574) ||               // last area added in 9.0.2 (36839)
        !sCharTitlesStore.LookupEntry(694) ||                // last char title added in 9.0.2 (36839)
        !sGemPropertiesStore.LookupEntry(3825) ||            // last gem property added in 9.0.2 (36839)
        !sItemStore.LookupEntry(184843) ||                   // last item added in 9.0.2 (36839)
        !sItemExtendedCostStore.LookupEntry(7047) ||         // last item extended cost added in 9.0.2 (36839)
        !sMapStore.LookupEntry(2453) ||                      // last map added in 9.0.2 (36839)
        !sSpellNameStore.LookupEntry(348491))                // last spell added in 9.0.2 (36839)
    {
...
{
    return GetChrSpecializationByIndex(class_, 1); // TODO 9.0.2
}
