...
struct ChrRacesEntry
{
    ...
    LocalizedString* NameRS;
    LocalizedString* NameRSFemale;
    LocalizedString* NameRSLowercase;
    LocalizedString* NameRSFemaleLowercase;
    LocalizedString* RaceFantasyDescription;
    LocalizedString* NameRL;
    LocalizedString* NameRLFemale;
    LocalizedString* NameRLLowercase;
    LocalizedString* NameRLFemaleLowercase;
    uint32 ID;
    int32 Flags;
    int32 BaseLanguage;
