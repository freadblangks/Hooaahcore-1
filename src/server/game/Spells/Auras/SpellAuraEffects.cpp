...
// such checks will speedup Hooaahcore change amount/send for client operations
...
void AuraEffect::HandlePeriodicHealthLeechAuraTick(Unit* target, Unit* caster) const
{
    ...
    SpellNonMeleeDamage log(caster, target, GetId(), GetBase()->GetSpellVisual(), GetSpellInfo()->GetSchoolMask(), GetBase()->GetCastGUID());
    log.damage = damage;
...
void AuraEffect::HandlePeriodicPowerBurnAuraTick(Unit* target, Unit* caster) const
{
    ...
    SpellNonMeleeDamage damageInfo(caster, target, spellProto->Id, GetBase()->GetSpellVisual(), spellProto->SchoolMask, GetBase()->GetCastGUID());
...
void AuraEffect::HandleProcTriggerDamageAuraProc(AuraApplication* aurApp, ProcEventInfo& eventInfo)
{
    ...
    SpellNonMeleeDamage damageInfo(target, triggerTarget, GetId(), GetBase()->GetSpellVisual(), GetSpellInfo()->SchoolMask, GetBase()->GetCastGUID());
