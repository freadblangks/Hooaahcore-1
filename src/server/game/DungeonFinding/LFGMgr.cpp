...
LFGDungeonData::LFGDungeonData() : id(0), name(""), map(0), type(0), subtype(0), expansion(0), randomId(0), difficulty(DIFFICULTY_NONE), seasonal(false), x(0.0f), y(0.0f), z(0.0f), o(0.0f), requiredItemLevel(0)
{
}
