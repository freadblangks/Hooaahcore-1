...
namespace BattlepayDisplayFlag
{
    enum : uint32
    {
        None                            = 0x000,
        Expansion                       = 0x001,
        CardDoesNotShowModel            = 0x002,
        CardAlwaysShowsTexture          = 0x004,
        HiddenPrice                     = 0x008,
        UseHorizontalLayoutForFullCard  = 0x010,
        Deprecated1                     = 0x020,
        Deprecated2                     = 0x040,
        UseSquareIconBorder             = 0x080,
        HideWhenOwned                   = 0x100,
        RafReward                       = 0x200,
...
namespace BattlepayProductGroupFlag
{
    ...
    {
        None                    = 0x000,
        HideOwnedProducts       = 0x001,
        EnabledForTrial         = 0x002,
        DisableOwnedProducts    = 0x004,
        EnabledForVeteran       = 0x008,
        Deprecated              = 0x010
    };
};

namespace BattlepayCardType
{
    enum : uint8
    {
        SmallCard                           = 0,
...
namespace StoreDeliveryType // not found in SL ???
{
    enum : uint32
    {
        Item = 0,
...
namespace Battlepay
{
    ...
    namespace BattlepayProductGroupFlag // ok 9.0.2
    {
        enum : uint8
        {
            None                    = 0x00,
            HideOwnedProducts       = 0x01,
            EnabledForTrial         = 0x02,
    ...
    enum PurchaseEligibility // ok 9.0.2
    {
        Ok                          = 0,
        PartiallyOwned              = 1,
        Owned                       = 2,
    ...
    namespace DistributionStatus // Not found on SL
    {
        enum
        {
    ...
    namespace VasPurchaseProgress // ok 9.0.2
    {
        enum : uint8
        {
            Invalid                     = 0,
